package com.aspect.demo.diyview;
...
public class FireView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private void drawFire(final Canvas canvas) {
        ...
        Observable.fromIterable(mFirePices).subscribe(new Consumer<FirePice>() {
            @Override
            public void accept(@NonNull FirePice firePice) throws Exception {
    ...
    public class FirePice {
        ...
        public void draw(Canvas mCanvas) {
            ...
            if (i < 2 * fireWidth && i > fireWidth / 5) {
                mPaint.setColor(Util.evaluate((float) (i * 1.0 / (2 * fireWidth)), startColor, endColor));
